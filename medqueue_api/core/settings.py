...
SECRET_KEY = 'django-insecure-luhq-^&dn&_0%7!61sune1(1xw&y*wk(gt64omnelsgrm)=nfw'
...
DEFAULT_FROM_EMAIL = 'MedQueue - <medqueue@gmail.com>'
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(minutes=60), # 1 soat amal qiladi
